...
namespace ReactiveTests.Tests
{
    ...
    public partial class ObservableBindingTest : ReactiveTest
    {
        ...
        {
            ReactiveAssert.Throws<ArgumentNullException>(() => Observable.LazyRefCount<int>(null, TimeSpan.FromSeconds(2)));
        }
        ...
        public void LazyRefCount_ConnectsOnFirst()
        {
            ...
            var res = scheduler.Start(() =>
                conn.LazyRefCount(TimeSpan.FromSeconds(2))
            );
        ...
        public void LazyRefCount_NotConnected()
        {
            ...
            var conn = new ConnectableObservable<int>(xs, subject);
            var refd = conn.LazyRefCount(TimeSpan.FromTicks(20), scheduler);
        ...
        public void LazyRefCount_OnError()
        {
            ...
            var res = xs.Publish().LazyRefCount(TimeSpan.FromSeconds(2));
        ...
        public void LazyRefCount_Publish()
        {
            ...
            var res = xs.Publish().LazyRefCount(TimeSpan.FromTicks(9), scheduler);
