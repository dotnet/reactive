...
{
    public abstract class TestBase : CSharpAnalyzerTest<AddUiFrameworkPackageAnalyzer, DefaultVerifier>
    {
        protected TestBase(ReferenceAssemblies referenceAssemblies)
        {
            SolutionTransforms.Add((solution, projectId) =>
            {
                ...
                solution = AdjustSolutionIfRequired(solution, project);
        ...
        protected virtual Solution AdjustSolutionIfRequired(Solution solution, Project project)
        {
            return solution;
        }

        protected abstract string GetRxDllPath();
    }
}
