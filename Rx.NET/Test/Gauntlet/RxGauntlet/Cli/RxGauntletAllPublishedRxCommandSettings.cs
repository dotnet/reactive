...
/// <summary>
/// Settings for the <c>test-all-published-rx</c> command.
/// </summary>
/// <remarks>
/// <para>
/// Annoyingly, we end up having to duplicate the <see cref="OutputDirectory"/> and <see cref="TestRunId"/>
/// that also appear in <see cref="RxGauntletCandidateCommandSettings"/>. See the remarks for
/// <see cref="IOrchestrationCommandSettings"/> for more information.
/// </remarks>
internal class RxGauntletAllPublishedRxCommandSettings : CommandSettings, IOrchestrationCommandSettings
{
